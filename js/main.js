/* ============================================================
   ...
   Typing effect · canvas de rede de dados · reveal on scroll ·
   contadores · i18n PT/EN
   ============================================================ */
...
const TYPED_ROLES = {
  pt: ["Engenheiro de Dados", "Analista de BI", "Cientista de Dados", "Python · SQL · Airflow"],
  en: ["Data Engineer", "BI Analyst", "Data Scientist", "Python · SQL · Airflow"],
};
  ...
  function tick() {
    ...
    if (!deleting) {
      ...
      if (charIdx === word.length) {
        deleting = true;
        typingTimer = setTimeout(tick, 2100);
        return;
      }
